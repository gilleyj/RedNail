    ...
    <div class="row">
        ...
        <div class="col-lg-5 well">
            ...
            <div class="well" class="">
                <button id="btnRace" name="btnRace" class="btn btn-info btn-block" data-toggle="modal" data-remote="<?=$this->_base_url;?>form/race/start" href="#form_start_race">Start race with this segment</button>
            </div>
